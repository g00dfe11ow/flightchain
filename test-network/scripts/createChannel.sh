...
infoln "Joining applicant peer to the channel..."
joinChannel applicant
infoln "Joining approver peer to the channel..."
joinChannel approver
infoln "Joining user peer to the channel..."
joinChannel user


## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for applicant..."
setAnchorPeer applicant
infoln "Setting anchor peer for approver..."
setAnchorPeer approver
